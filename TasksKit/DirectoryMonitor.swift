...
class DirectoryMonitor {
    ...
    let directoryMonitorQueue = dispatch_queue_create("com.locust123.tasker.directorymonitor", DISPATCH_QUEUE_CONCURRENT)
    ...
    func startMonitoring() {
        // Tasken for changes to the directory (if we are not already).
    ...
    func stopMonitoring() {
        // Stop taskening for changes to the directory, if the source has been created.
