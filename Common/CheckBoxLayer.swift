...
//  Created by Henry W. Lu on 5/17/15.
    ...
    Abstract:
    A `CALayer` subclass that draws a check box within its layer. This is shared between TasksKit on iOS and OS X to  to draw their respective `CheckBox` controls.
*/
